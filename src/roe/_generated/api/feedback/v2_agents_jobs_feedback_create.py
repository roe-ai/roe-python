...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v2/agents/{agent_id}/jobs/{job_id}/feedback/".format(agent_id=quote(str(agent_id), safe=""),job_id=quote(str(job_id), safe=""),),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    """ Submit agent job feedback (nested)

     Submit feedback for an agent job scoped to a base agent.

    Same storage and memory rules as the legacy feedback endpoint:
