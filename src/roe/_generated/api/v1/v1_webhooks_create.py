...
def _get_kwargs(
    *,
    body:    CreateWebhookRequest  |     CreateWebhookRequest  |     CreateWebhookRequest  | Unset = UNSET,
    ...
    if isinstance(body, CreateWebhookRequest):
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> CreateWebhook | None:
    if response.status_code == 201:
        response_201 = CreateWebhook.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[CreateWebhook]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        body (CreateWebhookRequest): Serializer for creating webhooks
        body (CreateWebhookRequest): Serializer for creating webhooks
        body (CreateWebhookRequest): Serializer for creating webhooks
