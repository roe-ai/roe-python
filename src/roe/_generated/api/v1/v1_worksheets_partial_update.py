...
from ...models.patched_worksheet_request import PatchedWorksheetRequest
...
def _get_kwargs(
    id: UUID,
    *,
    body:    PatchedWorksheetRequest  |     PatchedWorksheetRequest  |     PatchedWorksheetRequest  | Unset = UNSET,
    ...
    if isinstance(body, PatchedWorksheetRequest):
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (PatchedWorksheetRequest | Unset):
        body (PatchedWorksheetRequest | Unset):
        body (PatchedWorksheetRequest | Unset):
