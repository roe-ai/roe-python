...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> ErrorDetailResponse | list[AgentVersion] | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[ErrorDetailResponse | list[AgentVersion]]:
    return Response(
...
) -> Response[ErrorDetailResponse | list[AgentVersion]]:
    """ List agent versions.
...
def sync(
    ...
    *,
...
) -> ErrorDetailResponse | list[AgentVersion] | None:
    """ List agent versions.
    ...
    Returns:
        ErrorDetailResponse | list[AgentVersion]
     """
