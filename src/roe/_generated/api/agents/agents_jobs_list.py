...
from ...models.agents_jobs_list_ordering_item import AgentsJobsListOrderingItem
from ...models.agents_jobs_list_response_400 import AgentsJobsListResponse400
...
def _get_kwargs(
    ...
    *,
    ...
    ordering: list[AgentsJobsListOrderingItem] | Unset = UNSET,
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> AgentsJobsListResponse400 | ErrorDetailResponse | PaginatedListAgentJobList | None:
    ...
    if response.status_code == 400:
        response_400 = AgentsJobsListResponse400.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[AgentsJobsListResponse400 | ErrorDetailResponse | PaginatedListAgentJobList]:
    return Response(
...
def sync_detailed(
    ...
    *,
...
) -> Response[AgentsJobsListResponse400 | ErrorDetailResponse | PaginatedListAgentJobList]:
    ...
    Args:
        ...
        metadata (str | Unset):
        ordering (list[AgentsJobsListOrderingItem] | Unset):
        page (int | Unset):
        page_size (int | Unset):
        search (str | Unset):
...
def sync(
    ...
    *,
...
) -> AgentsJobsListResponse400 | ErrorDetailResponse | PaginatedListAgentJobList | None:
    """ List agent jobs or create a new agent job.
    ...
    Returns:
        AgentsJobsListResponse400 | ErrorDetailResponse | PaginatedListAgentJobList
     """
