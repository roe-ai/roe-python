...
from ...models.agent_version_update_request import AgentVersionUpdateRequest
...
def _get_kwargs(
    ...
    *,
    body: AgentVersionUpdateRequest | Unset = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (AgentVersionUpdateRequest | Unset):
