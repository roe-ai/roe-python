...
T = TypeVar("T", bound="ConnectionsCreateResponse400Type1")



@_attrs_define
class ConnectionsCreateResponse400Type1:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        connections_create_response_400_type_1 = cls(
        )
        ...
        connections_create_response_400_type_1.additional_properties = additional_properties
        return connections_create_response_400_type_1
