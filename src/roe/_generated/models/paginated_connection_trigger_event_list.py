...
T = TypeVar("T", bound="PaginatedConnectionTriggerEventList")



@_attrs_define
class PaginatedConnectionTriggerEventList:
    """ 
        Attributes:
            count (int):  Example: 123.
            results (list[ConnectionTriggerEvent]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in (_results):
            results_item = ConnectionTriggerEvent.from_dict(results_item_data)
        ...
        paginated_connection_trigger_event_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_connection_trigger_event_list.additional_properties = d
        return paginated_connection_trigger_event_list
