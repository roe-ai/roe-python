...
T = TypeVar("T", bound="PaginatedWorksheetList")



@_attrs_define
class PaginatedWorksheetList:
    """ 
        Attributes:
            count (int):  Example: 123.
            results (list[Worksheet]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in (_results):
            results_item = Worksheet.from_dict(results_item_data)
        ...
        paginated_worksheet_list.additional_properties = d
        return paginated_worksheet_list
