...
class WebhookTestRequest:
    """ Serializer for testing webhooks
        ...
        Attributes:
            message (str | Unset): Custom message to include in test payload Default: 'Test webhook from Roe'.
     """

    message: str | Unset = 'Test webhook from Roe'
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        webhook_test_request.additional_properties = d
