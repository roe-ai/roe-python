...
T = TypeVar("T", bound="PaginatedListAgentJobList")



@_attrs_define
class PaginatedListAgentJobList:
    """ 
        Attributes:
            count (int):  Example: 123.
            results (list[ListAgentJob]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in (_results):
            results_item = ListAgentJob.from_dict(results_item_data)
        ...
        paginated_list_agent_job_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_list_agent_job_list.additional_properties = d
        return paginated_list_agent_job_list
