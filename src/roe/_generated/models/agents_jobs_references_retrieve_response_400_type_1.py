...
T = TypeVar("T", bound="AgentsJobsReferencesRetrieveResponse400Type1")



@_attrs_define
class AgentsJobsReferencesRetrieveResponse400Type1:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        agents_jobs_references_retrieve_response_400_type_1 = cls(
        )
        ...
        agents_jobs_references_retrieve_response_400_type_1.additional_properties = additional_properties
        return agents_jobs_references_retrieve_response_400_type_1
