...
T = TypeVar("T", bound="TablesPreviewRetrieveResponse400Type1")



@_attrs_define
class TablesPreviewRetrieveResponse400Type1:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        tables_preview_retrieve_response_400_type_1 = cls(
        )
        ...
        tables_preview_retrieve_response_400_type_1.additional_properties = additional_properties
        return tables_preview_retrieve_response_400_type_1
