...
T = TypeVar("T", bound="PoliciesVersionsCreateResponse400")



@_attrs_define
class PoliciesVersionsCreateResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        policies_versions_create_response_400 = cls(
        )
        ...
        policies_versions_create_response_400.additional_properties = additional_properties
        return policies_versions_create_response_400
