...
T = TypeVar("T", bound="AgentsJobsResultsCreateResponse400")



@_attrs_define
class AgentsJobsResultsCreateResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        agents_jobs_results_create_response_400 = cls(
        )
        ...
        agents_jobs_results_create_response_400.additional_properties = additional_properties
        return agents_jobs_results_create_response_400
