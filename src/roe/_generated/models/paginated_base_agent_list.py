...
T = TypeVar("T", bound="PaginatedBaseAgentList")



@_attrs_define
class PaginatedBaseAgentList:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in (_results):
            results_item = BaseAgent.from_dict(results_item_data)
        ...
        paginated_base_agent_list.additional_properties = d
        return paginated_base_agent_list
