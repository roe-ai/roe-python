...
T = TypeVar("T", bound="PaginatedPolicyVersionList")



@_attrs_define
class PaginatedPolicyVersionList:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in (_results):
            results_item = PolicyVersion.from_dict(results_item_data)
        ...
        paginated_policy_version_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_policy_version_list.additional_properties = d
        return paginated_policy_version_list
