...
T = TypeVar("T", bound="AgentImportExportVersionRequest")



@_attrs_define
class AgentImportExportVersionRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        agent_import_export_version_request = cls(
            input_definitions=input_definitions,
            engine_config=engine_config,
        ...
        agent_import_export_version_request.additional_properties = d
        return agent_import_export_version_request
