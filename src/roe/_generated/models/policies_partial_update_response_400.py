...
T = TypeVar("T", bound="PoliciesPartialUpdateResponse400")



@_attrs_define
class PoliciesPartialUpdateResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        policies_partial_update_response_400 = cls(
        )
        ...
        policies_partial_update_response_400.additional_properties = additional_properties
        return policies_partial_update_response_400
