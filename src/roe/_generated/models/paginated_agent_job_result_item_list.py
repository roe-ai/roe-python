...
T = TypeVar("T", bound="PaginatedAgentJobResultItemList")



@_attrs_define
class PaginatedAgentJobResultItemList:
    """ 
        Attributes:
            count (int):  Example: 123.
            results (list[AgentJobResultItem]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in (_results):
            results_item = AgentJobResultItem.from_dict(results_item_data)
        ...
        paginated_agent_job_result_item_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_agent_job_result_item_list.additional_properties = d
        return paginated_agent_job_result_item_list
