...
T = TypeVar("T", bound="AgentsRunAsyncCreateResponse400Type1")



@_attrs_define
class AgentsRunAsyncCreateResponse400Type1:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        agents_run_async_create_response_400_type_1 = cls(
        )
        ...
        agents_run_async_create_response_400_type_1.additional_properties = additional_properties
        return agents_run_async_create_response_400_type_1
