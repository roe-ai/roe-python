...
T = TypeVar("T", bound="PaginatedFileList")
...
class PaginatedFileList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in (_results):
            results_item = File.from_dict(results_item_data)
        ...
        paginated_file_list.additional_properties = d
        return paginated_file_list
