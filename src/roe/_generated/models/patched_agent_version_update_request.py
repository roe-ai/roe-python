...
T = TypeVar("T", bound="PatchedAgentVersionUpdateRequest")



@_attrs_define
class PatchedAgentVersionUpdateRequest:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patched_agent_version_update_request = cls(
            version_name=version_name,
            description=description,
        )


        patched_agent_version_update_request.additional_properties = d
        return patched_agent_version_update_request
