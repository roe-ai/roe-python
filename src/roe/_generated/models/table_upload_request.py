...
T = TypeVar("T", bound="TableUploadRequest")



@_attrs_define
class TableUploadRequest:
    """ Serializer for public CSV table uploads.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        table_upload_request.additional_properties = d
        return table_upload_request
