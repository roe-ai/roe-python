...
T = TypeVar("T", bound="PoliciesCreateResponse400")



@_attrs_define
class PoliciesCreateResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        policies_create_response_400 = cls(
        )
        ...
        policies_create_response_400.additional_properties = additional_properties
        return policies_create_response_400
