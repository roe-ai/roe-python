...
T = TypeVar("T", bound="PaginatedConnectionTriggerList")



@_attrs_define
class PaginatedConnectionTriggerList:
    """ 
        Attributes:
            count (int):  Example: 123.
            results (list[ConnectionTrigger]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in (_results):
            results_item = ConnectionTrigger.from_dict(results_item_data)
        ...
        paginated_connection_trigger_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_connection_trigger_list.additional_properties = d
        return paginated_connection_trigger_list
