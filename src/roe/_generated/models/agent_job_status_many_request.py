...
T = TypeVar("T", bound="AgentJobStatusManyRequest")



@_attrs_define
class AgentJobStatusManyRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        agent_job_status_many_request = cls(
            job_ids=job_ids,
        )


        agent_job_status_many_request.additional_properties = d
        return agent_job_status_many_request
