...
T = TypeVar("T", bound="DiscoverySupportedModelsListResponse400")



@_attrs_define
class DiscoverySupportedModelsListResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        discovery_supported_models_list_response_400 = cls(
        )
        ...
        discovery_supported_models_list_response_400.additional_properties = additional_properties
        return discovery_supported_models_list_response_400
