...
T = TypeVar("T", bound="AgentsListResponse400")



@_attrs_define
class AgentsListResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        agents_list_response_400.additional_properties = additional_properties
        return agents_list_response_400
