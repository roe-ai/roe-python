...
T = TypeVar("T", bound="AgentsCreateResponse400")



@_attrs_define
class AgentsCreateResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        agents_create_response_400 = cls(
        )
        ...
        agents_create_response_400.additional_properties = additional_properties
        return agents_create_response_400
