...
T = TypeVar("T", bound="PaginatedWorksheetVersionList")



@_attrs_define
class PaginatedWorksheetVersionList:
    """ 
        Attributes:
            count (int):  Example: 123.
            results (list[WorksheetVersion]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in (_results):
            results_item = WorksheetVersion.from_dict(results_item_data)
        ...
        paginated_worksheet_version_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_worksheet_version_list.additional_properties = d
        return paginated_worksheet_version_list
