...
T = TypeVar("T", bound="AgentsVersionsCreateResponse400")



@_attrs_define
class AgentsVersionsCreateResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        agents_versions_create_response_400 = cls(
        )
        ...
        agents_versions_create_response_400.additional_properties = additional_properties
        return agents_versions_create_response_400
