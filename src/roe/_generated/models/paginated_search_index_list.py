...
T = TypeVar("T", bound="PaginatedSearchIndexList")



@_attrs_define
class PaginatedSearchIndexList:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in (_results):
            results_item = SearchIndex.from_dict(results_item_data)
        ...
        paginated_search_index_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_search_index_list.additional_properties = d
        return paginated_search_index_list
