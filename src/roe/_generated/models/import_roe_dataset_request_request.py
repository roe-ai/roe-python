...
T = TypeVar("T", bound="ImportRoeDatasetRequestRequest")



@_attrs_define
class ImportRoeDatasetRequestRequest:
    """ 
        Attributes:
            table_name (str):
            dataset_id (UUID):
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.sync_dataset, Unset):
            files.append(("sync_dataset", (None, str(self.sync_dataset).encode(), "text/plain")))
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        import_roe_dataset_request_request = cls(
            table_name=table_name,
            dataset_id=dataset_id,
        ...
        import_roe_dataset_request_request.additional_properties = d
        return import_roe_dataset_request_request
