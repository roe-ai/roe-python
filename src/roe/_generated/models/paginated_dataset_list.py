...
T = TypeVar("T", bound="PaginatedDatasetList")
...
class PaginatedDatasetList:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in (_results):
            results_item = Dataset.from_dict(results_item_data)
        ...
        paginated_dataset_list.additional_properties = d
