...
T = TypeVar("T", bound="PaginatedConnectionListList")



@_attrs_define
class PaginatedConnectionListList:
    """ 
        Attributes:
            count (int):  Example: 123.
            results (list[ConnectionList]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        paginated_connection_list_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_connection_list_list.additional_properties = d
        return paginated_connection_list_list
