...
T = TypeVar("T", bound="AgentsJobsListResponse400")



@_attrs_define
class AgentsJobsListResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        agents_jobs_list_response_400 = cls(
        )
        ...
        agents_jobs_list_response_400.additional_properties = additional_properties
        return agents_jobs_list_response_400
