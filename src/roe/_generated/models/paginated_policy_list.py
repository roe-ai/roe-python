...
T = TypeVar("T", bound="PaginatedPolicyList")



@_attrs_define
class PaginatedPolicyList:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in (_results):
            results_item = Policy.from_dict(results_item_data)
        ...
        paginated_policy_list.additional_properties = d
        return paginated_policy_list
