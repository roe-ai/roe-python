...
T = TypeVar("T", bound="UploadTableResponse400Type1")



@_attrs_define
class UploadTableResponse400Type1:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        upload_table_response_400_type_1 = cls(
        )
        ...
        upload_table_response_400_type_1.additional_properties = additional_properties
        return upload_table_response_400_type_1
