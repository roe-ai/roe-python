...
T = TypeVar("T", bound="AgentVersionUpdateRequest")



@_attrs_define
class AgentVersionUpdateRequest:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        agent_version_update_request = cls(
            version_name=version_name,
            description=description,
        )


        agent_version_update_request.additional_properties = d
        return agent_version_update_request
