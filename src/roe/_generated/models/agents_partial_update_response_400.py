...
T = TypeVar("T", bound="AgentsPartialUpdateResponse400")



@_attrs_define
class AgentsPartialUpdateResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        agents_partial_update_response_400 = cls(
        )
        ...
        agents_partial_update_response_400.additional_properties = additional_properties
        return agents_partial_update_response_400
