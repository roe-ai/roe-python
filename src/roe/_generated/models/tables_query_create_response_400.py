...
T = TypeVar("T", bound="TablesQueryCreateResponse400")



@_attrs_define
class TablesQueryCreateResponse400:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        tables_query_create_response_400 = cls(
        )
        ...
        tables_query_create_response_400.additional_properties = additional_properties
        return tables_query_create_response_400
