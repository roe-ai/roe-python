...
if TYPE_CHECKING:
  from ..models.create_webhook_request_headers import CreateWebhookRequestHeaders
...
class CreateWebhookRequest:
    """ Serializer for creating webhooks
        ...
        Attributes:
            ...
            secret (str | Unset):
            headers (CreateWebhookRequestHeaders | Unset): Custom headers to include in webhook requests (key-value pairs)
    ...
    headers: CreateWebhookRequestHeaders | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        headers: CreateWebhookRequestHeaders | Unset
        if isinstance(_headers,  Unset):
            headers = UNSET
        else:
            headers = CreateWebhookRequestHeaders.from_dict(_headers)
