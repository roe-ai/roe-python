...
T = TypeVar("T", bound="ConnectionsUpdateResponse400Type1")



@_attrs_define
class ConnectionsUpdateResponse400Type1:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        connections_update_response_400_type_1 = cls(
        )
        ...
        connections_update_response_400_type_1.additional_properties = additional_properties
        return connections_update_response_400_type_1
