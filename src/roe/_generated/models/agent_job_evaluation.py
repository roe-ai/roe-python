...
T = TypeVar("T", bound="AgentJobEvaluation")



@_attrs_define
class AgentJobEvaluation:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        agent_job_evaluation.additional_properties = d
        return agent_job_evaluation
