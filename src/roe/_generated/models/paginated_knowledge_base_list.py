...
T = TypeVar("T", bound="PaginatedKnowledgeBaseList")



@_attrs_define
class PaginatedKnowledgeBaseList:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in (_results):
            results_item = KnowledgeBase.from_dict(results_item_data)
        ...
        paginated_knowledge_base_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_knowledge_base_list.additional_properties = d
        return paginated_knowledge_base_list
